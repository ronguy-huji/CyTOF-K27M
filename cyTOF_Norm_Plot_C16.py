...
def dbscan_plot(data,eps=0.1,min_samples=50):
    ...
    plt.title('Deetected clusters: %d' % n_clusters_)
    plt.show()
    return labels
...
df=pd.read_csv(dir+"C15.csv")
dfmut=pd.read_csv(dir+"C16.csv")
