...
CAllmask=C14mask.append(C13mask)
...
CAll=CAll.assign(en0=eout[:,0])
CAll=CAll.assign(en1=eout[:,1])
...
# plt.figure(figsize=(6, 5))
# mask=CAll.clust==0
# plt.scatter(CAll[mask].en0,CAll[mask].en1,s=2,
#                 color='darkorange',label='H3K27M High')
# mask=CAll.clust==1
# plt.scatter(CAll[mask].en0,CAll[mask].en1,s=2,
#                 color='dimgray',label='H3K27M Low')
# plt.legend(markerscale=5,fontsize=15)
# plt.title("C14 AutoEncoder")
# plt.show()
...
plt.scatter(CAll[mask].umap0,CAll[mask].umap1,s=2,
                color='blue',label='WT (C13)')
plt.scatter(CAll[~mask].umap0,CAll[~mask].umap1,s=2,
                color='red',label='Mutant (C14)')
plt.legend(markerscale=5,fontsize=15)
plt.title("C14 AE + UMAP")
plt.show()
...
mask=CAll.clust==0
plt.scatter(CAll[mask].umap0,CAll[mask].umap1,s=2,
                color='darkorange',label='Mutant (C14) - H3K27M High')
mask=CAll.clust==1
plt.scatter(CAll[mask].umap0,CAll[mask].umap1,s=2,
                color='dimgray',label='Mutant (C14) - H3K27M Low')
plt.legend(markerscale=5,fontsize=15)
plt.title("C14 AE + UMAP")
plt.show()
'''
