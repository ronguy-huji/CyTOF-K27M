...
for NN in NamesAll:
    ...
    # cvals  = [cc.quantile(0.01), 0, cc.quantile(0.99)]
    ...
    plt.savefig("/Users/ronguy/Dropbox/Work/CyTOF/Plots/UMAP_"+TSNEVar+"_C14.png",
...
plt.title("C14")
plt.savefig("/Users/ronguy/Dropbox/Work/CyTOF/Plots/UMAP_Clusters_C14.png",
           dpi=100,bbox_inches = 'tight')
plt.show()
